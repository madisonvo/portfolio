...
public class IotStreamingAppPubSubToGCS {
    private static final Logger log = LoggerFactory.getLogger(IotStreamingAppPubSubToGCS.class);
    ...
    public static void run(Options options) {
        ...
        pipeline
            ...
            .apply("WriteToGCS", new WriteOneFilePerWindow(options.getTableName(), 1));
